...
public class PanelNoticiasEconomia extends JPanel {
	...
	public PanelNoticiasEconomia(Pantalla mainFrame) {
		setLayout(null);
		...
		// Titulo
		labelTitulo = new JLabel("Noticias Economia");
		...
		// 1 noticia
		webNoticia1 = new JLabel("El Economista");
	...
	public void cargarNoticias() {
		noticia1.setText(BuscarNoticias.noticia1Economia());
		noticia2.setText(BuscarNoticias.noticia2Economia());
		noticia3.setText(BuscarNoticias.noticia3Economia());
	}
}
