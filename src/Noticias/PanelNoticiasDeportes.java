...
public class PanelNoticiasDeportes extends JPanel {
	...
	public PanelNoticiasDeportes(Pantalla mainFrame) {
		setLayout(null);
		...
		// Titulo
		labelTitulo = new JLabel("Noticias Deportes");
		...
		// 1 noticia
		webNoticia1 = new JLabel("El País");
	...
	public void cargarNoticias() {
		noticia1.setText(BuscarNoticias.noticia1Deportes());
		noticia2.setText(BuscarNoticias.noticia2Deportes());
		noticia3.setText(BuscarNoticias.noticia3Deportes());
	}
}
