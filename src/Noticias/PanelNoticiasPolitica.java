...
public class PanelNoticiasPolitica extends JPanel {
	...
	public PanelNoticiasPolitica(Pantalla mainFrame) {
		...
		// 3 noticia
		webNoticia3 = new JLabel("La Vanguardia");
	...
	public void cargarNoticias() {
		noticia1.setText(BuscarNoticias.noticia1Politica());
		noticia2.setText(BuscarNoticias.noticia2Politica());
		noticia3.setText(BuscarNoticias.noticia3Politica());
	}
}