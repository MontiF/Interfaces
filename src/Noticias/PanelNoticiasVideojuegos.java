...
public class PanelNoticiasVideojuegos extends JPanel {
	...
	public void cargarNoticias() {
		noticia1.setText(BuscarNoticias.noticia1Videojuegos());
		noticia2.setText(BuscarNoticias.noticia2Videojuegos());
		noticia3.setText(BuscarNoticias.noticia3Videojuegos());
	}
}
