...
public class PanelNoticiasVideojuegos extends JPanel {
	...
	public PanelNoticiasVideojuegos(Pantalla mainFrame) {
		setLayout(null);
		...
		// Titulo
		labelTitulo = new JLabel("Noticias Videojuegos");
		...
		// 1 noticia
		webNoticia1 = new JLabel("Xataka");
		webNoticia1.setBounds(10, 123, 160, 34);
		webNoticia1.setFont(new Font("Segoe UI", Font.BOLD, 16));
		add(webNoticia1);
		noticia1 = new JTextArea(BuscarNoticias.noticia1Videojuegos());
		...
		// 2 noticia
		webNoticia2 = new JLabel("Vandal");
		webNoticia2.setBounds(10, 245, 160, 34);
		webNoticia2.setFont(new Font("Segoe UI", Font.BOLD, 16));
		add(webNoticia2);
		noticia2 = new JTextArea(BuscarNoticias.noticia2Videojuegos());
		...
		// 3 noticia
		webNoticia3 = new JLabel("El Tiempo");
		webNoticia3.setBounds(10, 356, 160, 34);
		webNoticia3.setFont(new Font("Segoe UI", Font.BOLD, 16));
		add(webNoticia3);
		noticia3 = new JTextArea(BuscarNoticias.noticia3Videojuegos());
